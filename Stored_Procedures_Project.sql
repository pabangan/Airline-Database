...
CALL spSearchFlightsByCityandTime('Chicago', GETDATE(), '2050-07-19 19:30:00') ;


-- Trip cancellation or change ------------------------------------------------------------------ 
DELIMITER //
CREATE PROCEDURE spDelFlightFromUser(IN input_userID INT, IN input_flightID)
BEGIN
	DELETE 
    FROM table_name 
    WHERE condition;
